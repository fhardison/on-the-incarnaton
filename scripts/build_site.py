...
template = Path('./rouse.html').read_text().replace('$body$', "<p style='text-align:center;'><a href='https://amindforlanguage.com/on-the-incarnaton/interlinear.html'>Interlinear </a><a href='https://amindforlanguage.com/on-the-incarnaton/vocab-data.html'>Vocabulary</a></p>\n" + output)
